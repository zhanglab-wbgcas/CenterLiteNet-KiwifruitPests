...
# MINI_IMAGENET_SPECS_DIR = Path("/public/home/ZXJ_liukc/few_shot_dir/01multi_weight_pro/data/part_25class_20per_mini")
MINI_IMAGENET_SPECS_DIR = Path("/public/home/ZXJ_liukc/few_shot_dir/01multi_weight_pro/data/part_20_miniimagenet/")
# MINI_IMAGENET_SPECS_DIR = Path("data/airplane/materials")
MINI_IMAGENET_images_DIR=Path("/public/home/ZXJ_liukc/few_shot_dir/01multi_weight_pro/data/part_20_miniimagenet/images")

class MiniImageNet(FewShotDataset):
    def __init__(
        self,
        root: MINI_IMAGENET_images_DIR,
    ...
    def load_specs(
        ...
        return pd.read_csv(specs_file).assign(
            image_path=lambda df: df.apply(
                ...
                # lambda row: self.root / row["label"] / row["filename"], axis=1
